                  ...
                  <div className="space-y-2">
                    ...
                    {editProductImage && (
                      <div className="w-14 h-14 border border-stone-200 rounded-xs overflow-hidden">
                        <img src={editProductImage.startsWith('http') ? editProductImage : `https://ozhan-back.onrender.com${editProductImage}`} alt={editProductName} className="w-full h-full object-cover" />
                      </div>
                    )}
                  </div>
                </div>
